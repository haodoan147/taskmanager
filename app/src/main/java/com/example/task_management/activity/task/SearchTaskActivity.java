    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(SearchTaskActivity.this, "Test Clicked", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SearchTaskActivity.this, MyProfileActivity.class);
        ...
        apiService.getAllTask(authHeader,1,100,"asc", status,"priority", "").enqueue(new Callback<PaginationTask>() {
            ...
            public void onResponse(Call<PaginationTask> call, Response<PaginationTask> response) {
                if (response.isSuccessful()) {
                    ...
                    taskAdapter = new TaskAdapter(SearchTaskActivity.this, taskList);
